...
function defUpperStr(param) {
    param = param ? param.toUpperCase() : 'DEFAULT TEXT';
    return param;
}
...
function weekFn (n) {
    switch (n) {
        case 1: dayOfWeek = week[0]; break;        
        case 2: dayOfWeek = week[1]; break; 
        case 3: dayOfWeek = week[2]; break;
        case 4: dayOfWeek = week[3]; break;
        case 5: dayOfWeek = week[4]; break;
        case 6: dayOfWeek = week[5]; break;
        case 7: dayOfWeek = week[6]; break;
